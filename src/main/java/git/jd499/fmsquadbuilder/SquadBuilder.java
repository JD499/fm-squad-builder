...
public class SquadBuilder extends Application {
  ...
  private final Map<String, List<String>> positionToRolesMap = new HashMap<>() {{
    put("ST (C)", Arrays.asList("DEEP_LYING_FORWARD_SUPPORT", "DEEP_LYING_FORWARD_ATTACK", "ADVANCED_FORWARD_ATTACK", "TARGET_FORWARD_SUPPORT", "TARGET_FORWARD_ATTACK", "POACHER_ATTACK", "COMPLETE_FORWARD_SUPPORT", "COMPLETE_FORWARD_ATTACK", "PRESSING_FORWARD_DEFEND", "PRESSING_FORWARD_SUPPORT", "PRESSING_FORWARD_ATTACK", "TREQUARTISTA_ATTACK", "FALSE_NINE_SUPPORT"));
    put("AM (C)", Arrays.asList("ATTACKING_MIDFIELDER_SUPPORT", "ATTACKING_MIDFIELDER_ATTACK", "ADVANCED_PLAYMAKER_SUPPORT", "ADVANCED_PLAYMAKER_ATTACK", "ENGANCHE_SUPPORT", "SHADOW_STRIKER_ATTACK"));
    put("AM (L)", Arrays.asList("WINGER_SUPPORT", "WINGER_ATTACK", "INSIDE_FORWARD_SUPPORT", "INSIDE_FORWARD_ATTACK", "WIDE_TARGET_FORWARD_SUPPORT", "WIDE_TARGET_FORWARD_ATTACK", "RAMDEUTER_ATTACK", "INVERTED_WINGER_SUPPORT", "INVERTED_WINGER_ATTACK"));
    put("AM (R)", Arrays.asList("WINGER_SUPPORT", "WINGER_ATTACK", "INSIDE_FORWARD_SUPPORT", "INSIDE_FORWARD_ATTACK", "WIDE_TARGET_FORWARD_SUPPORT", "WIDE_TARGET_FORWARD_ATTACK", "RAMDEUTER_ATTACK", "INVERTED_WINGER_SUPPORT", "INVERTED_WINGER_ATTACK"));
    put("M (C)", Arrays.asList("CENTRAL_MIDFIELDER_DEFEND", "CENTRAL_MIDFIELDER_SUPPORT", "CENTRAL_MIDFIELDER_ATTACK", "CENTRAL_MIDFIELDER_AUTOMATIC", "DEEP_LYING_PLAYMAKER_DEFEND", "DEEP_LYING_PLAYMAKER_SUPPORT", "BOX_TO_BOX_MIDFIELDER_SUPPORT", "BALL_WINNING_MIDFIELDER_DEFEND", "BALL_WINNING_MIDFIELDER_SUPPORT", "ROAMING_PLAYMAKER_SUPPORT", "MEZZALA_SUPPORT", "MEZZALA_ATTACK", "CARRILERO_SUPPORT"));
    put("M (L)", Arrays.asList("WIDE_MIDFIELDER_DEFEND", "WIDE_MIDFIELDER_SUPPORT", "WIDE_MIDFIELDER_ATTACK", "WIDE_MIDFIELDER_AUTOMATIC", "WINGER_SUPPORT", "WINGER_ATTACK", "DEFENSIVE_WINGER_DEFEND", "DEFENSIVE_WINGER_SUPPORT", "WIDE_PLAYMAKER_SUPPORT", "WIDE_PLAYMAKER_ATTACK", "INVERTED_WINGER_SUPPORT", "INVERTED_WINGER_ATTACK"));
    put("M (R)", Arrays.asList("WIDE_MIDFIELDER_DEFEND", "WIDE_MIDFIELDER_SUPPORT", "WIDE_MIDFIELDER_ATTACK", "WIDE_MIDFIELDER_AUTOMATIC", "WINGER_SUPPORT", "WINGER_ATTACK", "DEFENSIVE_WINGER_DEFEND", "DEFENSIVE_WINGER_SUPPORT", "WIDE_PLAYMAKER_SUPPORT", "WIDE_PLAYMAKER_ATTACK", "INVERTED_WINGER_SUPPORT", "INVERTED_WINGER_ATTACK"));
    put("DM", Arrays.asList("DEFENSIVE_MIDFIELDER_DEFEND", "DEFENSIVE_MIDFIELDER_SUPPORT", "DEEP_LYING_PLAYMAKER_DEFEND", "DEEP_LYING_PLAYMAKER_SUPPORT", "BALL_WINNING_MIDFIELDER_DEFEND", "BALL_WINNING_MIDFIELDER_SUPPORT", "ANCHOR_DEFEND", "HALF_BACK_DEFEND", "REGISTA_SUPPORT", "SEGUNDO_VOLANTE_SUPPORT", "SEGUNDO_VOLANTE_ATTACK"));
    put("WB (L)",Arrays.asList("WING_BACK_DEFEND", "WING_BACK_SUPPORT", "WING_BACK_ATTACK", "WING_BACK_AUTOMATIC", "COMPLETE_WING_BACK_SUPPORT", "COMPLETE_WING_BACK_ATTACK", "INVERTED_WING_BACK_DEFEND", "INVERTED_WING_BACK_SUPPORT", "INVERTED_WING_BACK_ATTACK", "INVERTED_WING_BACK_AUTOMATIC"));
    put("WB (R)",Arrays.asList("WING_BACK_DEFEND", "WING_BACK_SUPPORT", "WING_BACK_ATTACK", "WING_BACK_AUTOMATIC", "COMPLETE_WING_BACK_SUPPORT", "COMPLETE_WING_BACK_ATTACK", "INVERTED_WING_BACK_DEFEND", "INVERTED_WING_BACK_SUPPORT", "INVERTED_WING_BACK_ATTACK", "INVERTED_WING_BACK_AUTOMATIC"));
    put("D (C)", Arrays.asList("CENTRAL_DEFENDER_DEFEND", "CENTRAL_DEFENDER_STOPPER", "CENTRAL_DEFENDER_COVER", "LIBERO_SUPPORT", "LIBERO_ATTACK", "BALL_PLAYING_DEFENDER_DEFEND", "BALL_PLAYING_DEFENDER_STOPPER", "NO_NONSENSE_CENTRE_BACK_COVER", "NO_NONSENSE_CENTRE_BACK_DEFEND", "NO_NONSENSE_CENTRE_BACK_STOPPER", "NO_NONSENSE_CENTRE_BACK_COVER", "WIDE_CENTER_BACK_DEFEND", "WIDE_CENTER_BACK_SUPPORT", "WIDE_CENTER_BACK_ATTACK"));
    put("D (L)",Arrays.asList("FULL_BACK_DEFEND", "FULL_BACK_SUPPORT", "FULL_BACK_ATTACK", "FULL_BACK_AUTOMATIC","WING_BACK_DEFEND", "WING_BACK_SUPPORT", "WING_BACK_ATTACK", "WING_BACK_AUTOMATIC", "NO_NONSENSE_FULL_BACK_DEFEND", "INVERTED_WING_BACK_DEFEND", "INVERTED_WING_BACK_SUPPORT", "INVERTED_WING_BACK_ATTACK", "INVERTED_WING_BACK_AUTOMATIC"));
  ...
  private Circle createPlayerCircle() {
    ...
    System.out.println("Created circle with ID: " + circle.getId() + " and roles: " + rolesForCircle);
  ...
  private void configureComboBoxes(Pane container) {
    for (int i = 0; i < 11; i++) {
      ...
      comboBox.layoutXProperty().bind(container.widthProperty().subtract(comboBox.widthProperty()).divide(2));
    ...
    for (ComboBox<String> comboBox : comboBoxes) {
      if (comboBox.isDisable()) {
        ...
        for (String role : roles) {
          comboBox.getItems().addAll(positionToRolesMap.getOrDefault(role, Collections.emptyList()));
        }
  ...
  private void displayPlayersForPosition(List<Player> playersForPosition, String position) {
    if (blueCirclesCount <= playerLabels.size()) {
      if (!playersForPosition.isEmpty()) {
        ...
        if (bestPlayer != null) {
          playerLabels.get(blueCirclesCount - 1).setText(bestPlayer.getBasicInfo().getName());
        } else {
          playerLabels.get(blueCirclesCount - 1).setText("No Player for " + position + " in role " + selectedRole.name());
        }
      } else {
