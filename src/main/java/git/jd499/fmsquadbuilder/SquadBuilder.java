...
public class SquadBuilder extends Application {
  ...
  private void createSoccerField(Pane pane) {
    ...
    createPositionCircle(
        pane, 250, 250, Arrays.asList("AM (RLC)", "AM (LC)", "AM (RL)")); // AMC Left
    createPositionCircle(pane, 300, 250, Arrays.asList("AM (RLC)", "AM (LC)")); // AMC Center
    createPositionCircle(
        pane, 350, 250, Arrays.asList("AM (RLC)", "AM (LC)", "AM (RL)")); // AMC Right

    // Wing Midfielders
    createPositionCircle(pane, 150, 250, Arrays.asList("AM (RLC)", "AM (LC)", "AM (L)")); // AML
    createPositionCircle(
        pane, 450, 250, Arrays.asList("AM (RLC)", "AM (RC)", "AM (R)", "M/AM (R)")); // AMR
    ...
    // Central Midfielders
    createPositionCircle(
        pane, 250, 350, Arrays.asList("M (C)", "M (RC)", "M (LC)", "M/AM")); // CM Left
    createPositionCircle(
        pane, 300, 350, Arrays.asList("M (C)", "M (RC)", "M (LC)", "M/AM")); // CM Center
    createPositionCircle(
        pane, 350, 350, Arrays.asList("M (C)", "M (RC)", "M (LC)", "M/AM")); // CM Right
